...
import MessageTextarea from "@/components/sms/MessageTextarea";
      ...
      <div className="mt-4 border rounded-xl p-6">
        ...
        <div className="mb-4">
          <MessageTextarea
            ...
            onChange={setMessage}
            onCountChange={(info) => {
              setCharacterCount(info.characterCount);
              setSmsCount(info.smsCount);
            }}
            englishSingleLimit={engSingleSmsCount}
            englishMultiLimit={engMultiSmsCount}
            banglaSingleLimit={banglaSingleSmsCount}
            banglaMultiLimit={banglaMultiSmsCount}
          />
        </div>
